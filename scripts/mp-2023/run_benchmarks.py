...
bc_realistic_scenario_variable_cores_hyrise_master = [
    "sudo",
    "python3",
    "scripts/mp-2023/benchmark_multicore_over_cores.py",
]
bc_realistic_scenario_variable_cores_hyrise_master_cwd = "/mnt/md0/Theresa.Hradilak/hyrise_master/hyrise"

bc_realistic_scenario_variable_clients_hyrise_master = [
    "sudo",
    "python3",
    "scripts/mp-2023/benchmark_multicore_over_clients.py",
]
bc_realistic_scenario_variable_clients_hyrise_master_cwd = "/mnt/md0/Theresa.Hradilak/hyrise_master/hyrise"

bc_realistic_scenario_variable_cores_hyrise_mmap = [
    "sudo",
    "python3",
    "scripts/mp-2023/benchmark_multicore_over_cores.py",
]
...
bc_realistic_scenario_variable_clients_hyrise_mmap = [
    "sudo",
    "python3",
    "scripts/mp-2023/benchmark_multicore_over_clients.py",
]
...
bc_hyrise_mmap_limited_memory_sf_100 = [
    "sudo",
    "python3",
    "scripts/mp-2023/cgroups/run_cgroup_limited_benchmark_100.py",
]
