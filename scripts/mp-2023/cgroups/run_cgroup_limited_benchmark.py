...
for memory_limit in memory_limits:
    ...
    pagefault_stats[memory_limit]["before"] = get_memory_stats(
        cgroup_name, "Get memory stats of cgroup after finished setup."
    )

    try:
        p.wait(timeout=timeout_s)
        pagefault_stats[memory_limit]["after"] = get_memory_stats(
            cgroup_name, "Get memory stats after benchmark finished."
        )
