...
//       if (index == 0) {
//         mapped_chunks.emplace_back(sm._map_chunk_from_disk(sm.get_file_header_bytes(), file_name, COLUMN_COUNT));
//       } else {
//         mapped_chunks.emplace_back(
//             sm._map_chunk_from_disk(read_header.chunk_offset_ends[index - 1], file_name, COLUMN_COUNT));
//       }
//     }
...
//   void evaluate_mapped_chunk(const std::shared_ptr<Chunk>& chunk,
...
//   // print row 2 of created and mapped chunk
